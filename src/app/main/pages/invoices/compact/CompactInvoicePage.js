...
function CompactInvoicePage() {
  ...
  return (
    <div className={clsx(classes.root, 'flex-grow flex-shrink-0 p-0 sm:p-64 print:p-0 overflow-auto')}>
      {invoice && (
        <motion.div initial={{ opacity: 0, y: 200 }} animate={{ opacity: 1, y: 0 }} transition={{ bounceDamping: 0 }}>
            ...
            <CardContent className="p-88 print:p-0">
              ...
              <div className="flex justify-between">
                <div>
                  ...
                  {invoice.client.address && <Typography color="textSecondary">{invoice.client.address}</Typography>}
                  {invoice.client.phone && <Typography color="textSecondary">{invoice.client.phone}</Typography>}
                  {invoice.client.email && <Typography color="textSecondary">{invoice.client.email}</Typography>}
                  {invoice.client.website && <Typography color="textSecondary">{invoice.client.website}</Typography>}
                </div>
                ...
                <div className={clsx(classes.seller, 'flex items-center p-16')}>
                  ...
                  <div className="px-8">
                    ...
                    {invoice.from.address && <Typography color="inherit">{invoice.from.address}</Typography>}
                    {invoice.from.phone && <Typography color="inherit">{invoice.from.phone}</Typography>}
                    {invoice.from.email && <Typography color="inherit">{invoice.from.email}</Typography>}
                    {invoice.from.website && <Typography color="inherit">{invoice.from.website}</Typography>}
                  </div>
                </div>
              </div>
              ...
              <div className="mt-96">
                ...
                <div className="flex">
                  ...
                  <Typography className="font-normal mb-64 px-24" variant="caption" color="textSecondary">
                    ...
                    sem sit amet velit mollis, in porttitor ex finibus. Proin eu nibh id libero tincidunt lacinia et
                    eget eros.
                  </Typography>
                </div>
              </div>
