                  ...
                  default: {
                    return (
                      <TableCell key={column.id}>
                        <Typography color="textSecondary" className="font-semibold whitespace-nowrap p-8 px-16">
                          {column.title}
                        </Typography>
                      </TableCell>
                    );
              ...
              <TableRow key={row.id} className="h-64">
                {row.cells.map(cell => {
                  switch (cell.id) {
                    ...
                    case 'name': {
                      return (
                        <TableCell key={cell.id} component="th" scope="row" className="truncate font-semibold">
                          {cell.value}
                        </TableCell>
                      );
                    }
