        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="variant" aria-label="variant" value={variant} onChange={handleChange}>
          ...
          <Grid item xs={12} md={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="avatar" aria-label="avatar" value={avatar} onChange={handleChange}>
                <FormControlLabel value="none" control={<Radio />} label="none" />
          ...
          <Grid item xs={12} md={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="onDelete" aria-label="on delete" value={onDelete} onChange={handleChange}>
                <FormControlLabel value="none" control={<Radio />} label="none" />
                <FormControlLabel value="default" control={<Radio />} label="default" />
