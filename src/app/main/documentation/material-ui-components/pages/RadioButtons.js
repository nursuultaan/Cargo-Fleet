  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        Use <a href="https://material.io/design/components/selection-controls.html#radio-buttons">radio buttons</a> when
        the user needs to see all available options. If available options can be collapsed, consider using a dropdown
      ...
      <Typography className="mb-16" component="div">
        To lay out the buttons horizontally, set the <code>{`row`}</code> prop: <code>{`<RadioGroup row />`}</code>.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/radio-buttons/RadioButtons.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/radio-buttons/ErrorRadios.js').default
          }
