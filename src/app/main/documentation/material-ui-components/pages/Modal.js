...
function ModalDoc(props) {
  ...
  return (
    <>
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          <strong>Terminology note</strong>. The term &quot;modal&quot; is sometimes used to mean &quot;dialog&quot;,
          but this is a misnomer. A modal window describes parts of a UI. An element is considered modal if{' '}
      ...
      <Typography className="mb-16" component="div">
        If you are creating a modal dialog, you probably want to use the <a href="/components/dialogs/">Dialog</a>{' '}
        component rather than directly using Modal. Modal is a lower-level construct that is leveraged by the following
        components:
      </Typography>
      <ul>
        <li>
      ...
      <Typography className="mb-16" component="div">
        Notice that you can disable the outline (often blue or gold) with the <code>{`outline: 0`}</code> CSS property.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        Transitions
      </Typography>
      <Typography className="mb-16" component="div">
        The open/close state of the modal can be animated with a transition component. This component should respect the
      ...
      <ul>
        ...
        <li>
          ...
          allow the modal to unmount the child content when closed and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/modal/TransitionsModal.js').default
          }
          raw={require('!raw-loader!app/main/documentation/material-ui-components/components/modal/TransitionsModal.js')}
        />
      </Typography>
      <Typography className="mb-16" component="div">
        Alternatively, you can use <a href="https://github.com/react-spring/react-spring">react-spring</a>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
...
`}
        ...
        <li>
          <Typography className="mb-16" component="div">
            Keep in mind that a &quot;modal window&quot; overlays on either the primary window or another modal window.
            Windows under a modal are <strong>inert</strong>. That is, users cannot interact with content outside an
            active modal window. This might create <a href="#focus-trap">conflicting behaviors</a>.
          </Typography>
        </li>
      </ul>
    </>
