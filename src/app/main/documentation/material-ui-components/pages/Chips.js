  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/chips.html">Chips</a> allow users to enter information, make
      ...
      <Typography className="mb-16" component="div">
        ...
        behaviour demonstrated here is not shown in context.
      </Typography>
      ...
      <ul>
        <li>
          Chips with the <code>{`onClick`}</code> property defined change appearance on focus, hover, and click.
        </li>
        <li>
          Chips with the <code>{`onDelete`}</code> property defined will display a delete icon which changes appearance
          on hover.
        </li>
      </ul>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        ...
        that since no
        <code>{`onClick`}</code> property is defined, the Chip can be focused, but does not gain depth while clicked or
        touched.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/chips/SmallOutlinedChips.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/chips/ChipsPlayground.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        tabbing) releasing (<code>{`keyup`}</code> event) <code>{`Backspace`}</code> or <code>{`Delete`}</code> will
