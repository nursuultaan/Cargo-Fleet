  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/archive/guidelines/components/steppers.html">Steppers</a> display progress through
        a sequence of logical and numbered steps. They may also be used for navigation. Steppers may display a transient
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ...
          <a href="https://material.io/">Material Design guidelines</a>, but Material-UI will continue to support them.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{`activeStep`}</code> property. <code>{`Stepper`}</code> orientation is set using the{' '}
        <code>{`orientation`}</code> property.
      </Typography>
      <Typography className="mb-16" component="div">
        This example also shows the use of an optional step by placing the <code>{`optional`}</code> property on the
        second <code>{`Step`}</code> component. Note that it&#39;s up to you to manage when an optional step is skipped.
        Once you&#39;ve determined this for a particular step you must set <code>{`completed={false}`}</code> to signify
        that even though the active step index has gone beyond the optional step, it&#39;s not actually complete.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/steppers/CustomizedSteppers.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{`disabled={true}`}</code> based on the <code>{`activeStep`}</code> property.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        This is essentially a back/next button positioned correctly. You must implement the textual description
        yourself, however, an example is provided below for reference.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/steppers/TextMobileStepper.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/oliviertassinari/react-swipeable-views">react-swipeable-views</a> to make the
        transition of steps.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/steppers/DotsMobileStepper.js').default
          }
