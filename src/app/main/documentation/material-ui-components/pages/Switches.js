  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/selection-controls.html#switches">Switches</a> are the preferred
        way to adjust settings on mobile. The option that the switch controls, as well as the state it’s in, should be
      ...
      <Typography className="mb-16" component="div">
        <code>{`Switch`}</code> can be provided with a description thanks to the <code>{`FormControlLabel`}</code>{' '}
        component.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/switches/SwitchLabels.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        easier API. However, you are encouraged you to use <a href="/components/checkboxes/">Checkboxes</a> instead if
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/switches/SwitchesGroup.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/switches/CustomizedSwitches.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/switches/SwitchesSize.js').default
          }
      ...
      <ul>
        <li>
          It will render an element with the <code>{`checkbox`}</code> role not <code>{`switch`}</code> role since this
          role isn&#39;t widely supported yet. Please test first if assistive technology of your target audience
        ...
        <li>
          ...
          this case, you can apply the additional attribute (e.g. <code>{`aria-label`}</code>,{' '}
