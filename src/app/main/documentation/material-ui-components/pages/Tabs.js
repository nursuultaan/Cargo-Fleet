  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/tabs.html">Tabs</a> organize and allow navigation between groups
        of content that are related and at the same level of hierarchy.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        Long labels will automatically wrap on tabs. If the label is too long for the tab, it will overflow and the text
        will not be visible.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/tabs/TabsWrappedLabel.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        The <code>{`variant="fullWidth"`}</code> property should be used for smaller views. This demo also uses{' '}
      ...
      <Typography className="mb-16" component="div">
        Left and right scroll buttons will automatically be presented on desktop and hidden on mobile. (based on
        viewport width)
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/tabs/ScrollableTabsButtonAuto.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        Left and right scroll buttons will never be presented. All scrolling must be initiated through user agent
      ...
      <Typography className="mb-16" component="div">
        By default tabs use a <code>{`button`}</code> element, but you can provide your own custom tag or component.
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="#experimental-api">an experimental API</a> in <code>{`@material-ui/lab`}</code> that does not require
        extra work.
      </Typography>
      <Typography className="text-24 mt-32 mb-8" component="h3">
        Keyboard navigation
...
`}
      ...
      <Typography className="mb-16" component="div">
        <code>{`@material-ui/lab`}</code> offers utility components that inject props to implement accessible tabs
        following <a href="https://www.w3.org/TR/wai-aria-practices/#tabpanel">WAI-ARIA authoring practices</a>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
