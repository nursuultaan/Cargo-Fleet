  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/buttons.html">Buttons</a> communicate actions that users can
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/buttons.html#contained-button">Contained buttons</a>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/ContainedButtons.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/DisableElevation.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/buttons.html#outlined-button">Outlined buttons</a>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/OutlinedButtons.js').default
          }
...
`}
      ...
      <Typography className="mb-16" component="div">
        Note that the documentation <a href="/guides/api/#native-properties">avoids</a> mentioning native props (there
        are a lot) in the API section of the components.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        Upload button
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/UploadButtons.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        Sometimes you might want to have icons for certain button to enhance the UX of the application as we recognize
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/IconLabelButtons.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/buttons/CustomizedButtons.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        One common use case is to use the button to trigger navigation to a new page. The <code>{`ButtonBase`}</code>{' '}
        component provides a property to handle this use case: <code>{`component`}</code>. However for certain focus
        polyfills <code>{`ButtonBase`}</code> requires the DOM node of the provided component. This is achieved by
        attaching a ref to the component and expecting that the component forwards this ref to the underlying DOM node.
        Given that many of the interactive components rely on <code>{`ButtonBase`}</code>, you should be able to take
        advantage of it everywhere.
      </Typography>
      <Typography className="mb-16" component="div">
