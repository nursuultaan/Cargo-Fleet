  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/snackbars.html">Snackbars</a> inform users of a process that an
        app has performed or will perform. They appear temporarily, towards the bottom of the screen. They shouldn’t
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/SimpleSnackbar.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/CustomizedSnackbars.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        In wide layouts, snackbars can be left-aligned or center-aligned if they are consistently placed on the same
        spot at the bottom of the screen, however there may be circumstances where the placement of the snackbar needs
        to be more flexible. You can control the position of the snackbar by specifying the{' '}
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/PositionedSnackbar.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/LongTextSnackbar.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <a href="/components/transitions/#grow">Grow</a> is the default transition but you can use a different one.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/TransitionsSnackbar.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        You can change the direction of the <a href="/components/transitions/#slide">Slide</a> transition.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/snackbars/DirectionSnackbar.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        {' '}
        src="https://img.shields.io/github/stars/iamhosseindhv/notistack.svg?style=social&label=Stars" alt="stars/>
        src="https://img.shields.io/npm/dm/notistack.svg" alt="npm downloads/>
      </Typography>
      <Typography className="mb-16" component="div">
        This example demonstrates how to use <a href="https://github.com/iamhosseindhv/notistack">notistack</a>.
        notistack has an <strong>imperative API</strong> that makes it easy to display snackbars, without having to
        handle their open/close state. It also enables you to <strong>stack</strong> them on top of one another
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA: <a href="https://www.w3.org/TR/wai-aria-1.1/#alert">https://www.w3.org/TR/wai-aria-1.1/#alert</a>)
      </Typography>
      <ul>
        <li>
          ...
          <a href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/time-limits.html">sufficient time</a> to respond.
        </li>
      </ul>
    </>
  );
