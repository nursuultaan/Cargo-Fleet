  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/navigation-drawer.html">Navigation drawers</a> (or
        &quot;sidebars&quot;) provide access to destinations and app functionality, such as switching accounts. They can
        either be permanently on-screen or controlled by a navigation menu icon.
      </Typography>
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/sheets-side.html">Side sheets</a> are supplementary surfaces
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/TemporaryDrawer.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        follow the fingers at 60 FPS. You can use the <code>{`disableBackdropTransition`}</code> property to help.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-16" component="div">
        The <code>{`Hidden`}</code> responsive helper component allows showing different types of drawer depending on
        the screen width. A <code>{`temporary`}</code> drawer is shown for small screens while a{' '}
        <code>{`permanent`}</code> drawer is shown for wider screens.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/ResponsiveDrawer.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/PersistentDrawerLeft.js').default
          }
        ...
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/PersistentDrawerRight.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/PermanentDrawerLeft.js').default
          }
        ...
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/PermanentDrawerRight.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/drawers/ClippedDrawer.js').default
          }
