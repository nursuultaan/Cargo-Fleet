  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        The Link component is built on top of the <a href="/api/typography/">Typography</a> component. You can leverage
        its properties.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <ul>
        ...
        <li>
          <code>{`variant="inherit"`}</code> as the link will, most of the time, be used as a child of a Typography
          component.
        </li>
      </ul>
      <Typography className="text-32 mt-32 mb-8" component="h2">
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://developers.google.com/web/tools/lighthouse/audits/noopener">recommended</a> to always set{' '}
        <code>{`rel="noopener"`}</code> or <code>{`rel="noreferrer"`}</code> when linking to third party content.
      </Typography>
      <ul>
        <li>
          <code>{`rel="noopener"`}</code> prevents the new page from being able to access the{' '}
          <code>{`window.opener`}</code> property and ensures it runs in a separate process. Without this, the target
          page can potentially redirect your page to a malicious URL.
        </li>
        <li>
          <code>{`rel="noreferrer"`}</code> has the same effect, but also prevents the <em>Referer</em> header from
          being sent to the new page. ⚠️ Removing the referrer header will affect analytics.
        </li>
      </ul>
      <Typography className="text-32 mt-32 mb-8" component="h2">
      ...
      <Typography className="mb-16" component="div">
        One common use case is to perform navigation on the client only, without an HTTP round-trip to the server. The{' '}
        <code>{`Link`}</code> component provides a property to handle this use case: <code>{`component`}</code>.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        (WAI-ARIA:{' '}
        <a href="https://www.w3.org/TR/wai-aria-practices/#link">https://www.w3.org/TR/wai-aria-practices/#link</a>)
      </Typography>
      <ul>
        <li>
