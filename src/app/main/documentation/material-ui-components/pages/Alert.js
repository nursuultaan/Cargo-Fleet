    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/alert/DescriptionAlerts.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        displayed. The <code>{`action`}</code> prop can be used to provide an alternative action, for example using a
      ...
      <Typography className="mb-16" component="div">
        You can use a <a href="/components/transitions/">transition component</a> such as <code>{`Collapse`}</code> to
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/alert/TransitionAlerts.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        defined globally using <a href="/customization/globals/#default-props">theme customization</a>.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/alert/OutlinedAlerts.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        You can use the Snackbar to <a href="/components/snackbars/#customized-snackbars">display a toast</a> with the
        Alert.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        Color
