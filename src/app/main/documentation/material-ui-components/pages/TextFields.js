  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/text-fields.html">Text fields</a> allow users to enter text into
      ...
      <Typography className="mb-16" component="div">
        The <code>{`TextField`}</code> wrapper component is a complete form control including a label, input and help
        text.
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/BasicTextFields.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea">textarea</a> or a{' '}
        <a href="/components/textarea-autosize/">TextareaAutosize</a>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        The <code>{`select`}</code> prop makes the text field use the <a href="/components/selects/">Select</a>{' '}
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/SelectTextFields.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/InputWithIcon.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/InputAdornments.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/TextFieldSizes.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        (default) will not apply margins to the <code>{`FormControl`}</code>, whereas <code>{`dense`}</code> and{' '}
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/LayoutTextFields.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/StateTextFields.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>{`inputProps`}</code> (and <code>{`InputProps`}</code>, <code>{`InputLabelProps`}</code> properties) if
        you want to avoid some boilerplate.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/ComposedTextField.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/ColorTextFields.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/CustomizedInputs.js').default
          }
...
`}
      ...
      <Typography className="mb-16" component="div">
        The floating label is absolutely positioned, it won&#39;t impact the layout of the page. You need to make sure
        that the input is larger than the label to display correctly.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
      ...
      <Typography className="mb-16" component="div">
        The following demo uses the <a href="https://github.com/text-mask/text-mask">react-text-mask</a> and{' '}
        <a href="https://github.com/s-yadav/react-number-format">react-number-format</a> libraries. The same concept
        could be applied to <a href="https://github.com/mui-org/material-ui/issues/16037">e.g. react-stripe-element</a>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/text-fields/FormattedInputs.js').default
          }
          raw={require('!raw-loader!app/main/documentation/material-ui-components/components/text-fields/FormattedInputs.js')}
        />
      </Typography>
      <Typography className="mb-16" component="div">
        The provided input component should handle the <code>{`inputRef`}</code> property. The property should be called
        with a value that implements the following interface:
      </Typography>
...
`}
      ...
      <ul>
        <li>
          <a href="https://github.com/stackworx/formik-material-ui">formik-material-ui</a> Bindings for using
          Material-UI with <a href="https://jaredpalmer.com/formik">formik</a>.
        </li>
        <li>
          <a href="https://github.com/erikras/redux-form-material-ui">redux-form-material-ui</a> Bindings for using
          Material-UI with <a href="https://redux-form.com/">Redux Form</a>.
        </li>
        <li>
