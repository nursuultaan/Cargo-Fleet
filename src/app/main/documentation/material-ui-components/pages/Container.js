    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/container/SimpleContainer.js').default
          }
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        can set the <code>{`fixed`}</code> property. The max-width matches the min-width of the current breakpoint.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={true}
          component={
            require('app/main/documentation/material-ui-components/components/container/FixedContainer.js').default
          }
