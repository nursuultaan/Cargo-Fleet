...
function PopperDoc(props) {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          🕷 Popper relies on the 3rd party library (<a href="https://github.com/FezVrasta/popper.js">Popper.js</a>) for
          perfect positioning.
        </li>
        <li>💄 It&#39;s an alternative API to react-popper. It aims for simplicity.</li>
        <li>
          📦 <a href="/size-snapshot">10 kB gzipped</a> (<a href="https://bundlephobia.com/result?p=popper.js">7 kB</a>{' '}
          from Popper.js).
        </li>
        <li>
          The children is{' '}
        ...
        <li>
          ...
          - see the example in the <a href="/components/menus/#menulist-composition">menu documentation section</a>.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          allow the popper to unmount the child content when closed and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/popper/TransitionsPopper.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/popper/PositionedPopper.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/popper/ScrollPlayground.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        The <code>{`anchorEl`}</code> property can be a reference to a fake DOM element. You just need to create an
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/popper/FakedReferencePopper.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/popper/PopperPopupState.js').default
          }
