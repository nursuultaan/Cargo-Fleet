    ...
    <>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/breadcrumbs/SimpleBreadcrumbs.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/breadcrumbs/CustomSeparator.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/breadcrumbs/IconBreadcrumbs.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/breadcrumbs/RouterBreadcrumbs.js').default
          }
      ...
      <ul>
        ...
        <li>
          A nav element labeled with <code>{`aria-label`}</code> identifies the structure as a breadcrumb trail and
          makes it a navigation landmark so that it is easy to locate.
        </li>
      </ul>
    </>
  );
