...
function AutocompleteDoc(props) {
  ...
  return (
    <>
      ...
      <ol>
        <li>
          The value for the textbox must be chosen from a predefined set of allowed values, e.g., a location field must
          contain a valid location name: <a href="#combo-box">combo box</a>.
        </li>
        <li>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/ComboBox.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/Playground.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/CountrySelect.js').default
          }
      ...
      <ol>
        <li>
          the &quot;value&quot; state with the <code>{`value`}</code>/<code>{`onChange`}</code> props combination. This
          state represents the value selected by the user, for instance when pressing <kbd>Enter</kbd>.
        </li>
        <li>
      ...
      <Typography className="mb-16" component="div">
        The prop is designed to cover the primary use case of a <strong>search input</strong> with suggestions, e.g.
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/FreeSolo.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        If you intend to use this mode for a <a href="#combo-box">combo box</a> like experience (an enhanced version of
        a select element) we recommend setting:
      </Typography>
      <ul>
        <li>
        ...
        <li>
          <code>{`handleHomeEndKeys`}</code> to move focus inside the popup with the <kbd>Home</kbd> and <kbd>End</kbd>{' '}
          keys.
        </li>
        <li>
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/Grouped.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/DisabledOptions.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        For advanced customization use cases, we expose a headless <code>{`useAutocomplete()`}</code> hook. It accepts
        almost the same options as the Autocomplete component minus all the props related to the rendering of JSX. The
        Autocomplete component uses this hook internally.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/UseAutocomplete.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/CustomizedHook.js').default
          }
          raw={require('!raw-loader!app/main/documentation/material-ui-components/components/autocomplete/CustomizedHook.js')}
        />
      </Typography>
      <Typography className="mb-16" component="div">
        Head to the <a href="#customized-autocomplete">Customized Autocomplete</a> section for a customization example
        with the <code>{`Autocomplete`}</code> component instead of the hook.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/Asynchronous.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/GoogleMaps.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://developers.google.com/maps/documentation/javascript/tutorial">Google Maps JavaScript</a> API.
      </Typography>
      <blockquote>
        <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        In the event that you need to lock certain tag so that they can&#39;t be removed in the interface, you can set
        the chips disabled.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/FixedTags.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/CheckboxesTags.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/LimitTags.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/GitHubLabel.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="https://github.com/moroshko/autosuggest-highlight">autosuggest-highlight</a>, a small (1 kB) utility
        for highlighting text in autosuggest and autocomplete components.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/Highlights.js').default
          }
...
`}
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>{`config.ignoreAccents`}</code> (<em>Boolean</em> [optional]): Defaults to <code>{`true`}</code>.
              Remove diacritics.
            </li>
            <li>
              <code>{`config.ignoreCase`}</code> (<em>Boolean</em> [optional]): Defaults to <code>{`true`}</code>.
              Lowercase everything.
            </li>
            <li>
              <code>{`config.limit`}</code> (<em>Number</em> [optional]): Default to null. Limit the number of suggested
              options to be shown. For example, if <code>{`config.limit`}</code> is <code>{`100`}</code>, only the first{' '}
              <code>{`100`}</code> matching options are shown. It can be useful if a lot of options match and
            ...
            <li>
              <code>{`config.trim`}</code> (<em>Boolean</em> [optional]): Defaults to <code>{`false`}</code>. Remove
              trailing spaces.
            </li>
          </ul>
        </li>
...
`}
      ...
      <Typography className="mb-16" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/documentation/material-ui-components/components/autocomplete/Virtualize.js').default
          }
      ...
      <Typography className="mb-16" component="div">
        The browsers have heuristics to help the users fill the form inputs. However, it can harm the UX of the
        component.
      </Typography>
      <Typography className="mb-16" component="div">
        By default, the component disable the <strong>autocomplete</strong> feature (remembering what the user has typed
        for a given field in a previous session) with the <code>{`autoComplete="off"`}</code> attribute.
      </Typography>
      <Typography className="mb-16" component="div">
        However, in addition to remembering past entered values, the browser might also propose{' '}
        <strong>autofill</strong> suggestions (saved login, address, or payment details). In the event you want the
        avoid autofill, you can try the following:
      </Typography>
      <ul>
        <li>
          <Typography className="mb-16" component="div">
            Name the input without leaking any information the browser can use. e.g. <code>{`id="field1"`}</code>{' '}
            instead of <code>{`id="country"`}</code>. If you leave the id empty, the component uses a random id.
          </Typography>
        </li>
        <li>
          <Typography className="mb-16" component="div">
...
`}
      ...
      <Typography className="mb-16" component="div">
        If you provide a custom <code>{`ListboxComponent`}</code> prop, you need to make sure that the intended scroll
        container has the <code>{`role`}</code> attribute set to <code>{`listbox`}</code>. This ensures the correct
        behavior of the scroll, for example when using the keyboard to navigate.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        Accessibility
      </Typography>
