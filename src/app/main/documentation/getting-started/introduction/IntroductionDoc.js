...
function IntroductionDoc() {
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        While Fuse React is a great tool and source for learning React, it also requires at least an entry-level of
        React, Redux knowledge so you can find your way within the source code.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        is the core of our template. If you don't know what React is or don't know how to use it, we strongly recommend
        checking the React before start doing anything with Fuse.
      </Typography>
      <Typography className="mt-32 mb-8" variant="h5">
        Material-UI
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        is a tool built by developers at Facebook to help you build React applications. It saves you from time-consuming
