    ...
    <>
      ...
      <div className="my-24 px-12 py-8 border-1 border-red rounded-16">
        ...
        <Typography className="" component="div">
          ...
          <br />
          if not recover the contents and add <code>yarnPath: ".yarn/releases/yarn-berry.js"</code> at the top.
        </Typography>
      </div>
      ...
      <Typography className="my-16" component="div">
        <ol>
          <li className="mb-16">
            ...
            Skeleton Project <b>(Fuse-react-x.x.x-skeleton.zip)</b> along with the Demo Project{' '}
            <b>(Fuse-react-x.x.x-demo.zip)</b>, PSD designs and a readme file.
          </li>
          <li className="mb-16">
            Extract the contents of the zip file <b>(Fuse-react-x.x.x-skeleton.zip)</b> into a folder that you will work
            within. For this documentation, we will refer that as "your work folder".
          </li>
          <li className="mb-16">
            Open your favorite console application (Terminal, Command Prompt, etc.), navigate into your work folder, run
            the following command, and wait for it to finish:
            <FuseHighlight component="pre" className="language-bash my-16">
              {`
                                      yarn
                                    `}
            </FuseHighlight>
            This command will install all the required Node.js modules into the node_modules directory inside your work
            folder.
