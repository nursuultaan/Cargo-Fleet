...
function ThemeLayoutsDoc() {
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        These layouts are accessible from <code>/src/app/fuse-layouts</code> directory and you can modify them however
        you like. Each layout has its own options. Those options allow you to configure the layout elements such as
        Toolbar, Footer, and Navbar.
      </Typography>
