  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        ...
        adds a custom direction variant to your tailwind project, letting you have custom CSS rules for LTR and RTL
        layouts. For example:
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        If you need to change theme direction dynamically, for example when you need to change LTR to RTL language, you
        need dispatch an action as below:
      </Typography>
